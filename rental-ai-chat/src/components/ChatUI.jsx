    ...
    try {
      ...
      if (uploadData.detected_state && uploadData.detected_state !== selectedState) {
        setMessages((prev) => [
          ...
          {
            role: "assistant",
            content: `Note: I detected this is a ${uploadData.detected_state} document, but you selected ${selectedState}. I'll analyze it using ${uploadData.state} laws for accuracy.`,
          },
        ]);
      }
